...
month_order <- c("Jan", "Feb", "Sep", "Oct", "Nov", "Dec")
...
pats_elo_data <- nfl_elo_data |> 
  ...
  mutate(opponent_score = if_else(team1 == "NE", score2, if_else(team2 == "NE", score1, NA_real_))) |> 
